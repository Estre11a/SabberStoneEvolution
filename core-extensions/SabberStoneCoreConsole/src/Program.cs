...
namespace SabberStoneCoreConsole
{
	...
	internal class Program
	{
		...
		//====================================================================
		public static string UnitTest(string InputPath, string OutputPath)
		{
			...
			while ((line = sr.ReadLine()) != null)
			{
				...
				Card card1 = Cards.FromName(Combo[0]);
				Card card2 = Cards.FromName(Combo[1]);
				int Score = -1;
				if (card1 != null && card2 != null)
				{
					Console.WriteLine(card1.Type + " " + card2.Type);
					Score = OneToNine(new Card[]{card1, card2});
				}
				sw.Write(Score + "\n");
				sw.Flush();
		...
		public static int OneToNine(Card[] Combo)
		{
			...
			//UnitTest(MinionsToAttack[7], MinionsWithBuff[1, 0], MinionsWithBuff[1, 1]);
